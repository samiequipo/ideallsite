Rails.application.routes.draw do
  ...
  scope :servicos do
    namespace :pacotes do
      get 'pacotes_nos', to: "pacotes_nos#index"
      get 'tv_net_voz', to: "pacotes_nos#tv_net_voz", as: "tv_net_voz_vodafone"
      get 'telemovel', to: "pacotes_nos#telemovel", as: "telemovel_vodafone"
      get 'gaming', to: "pacotes_nos#gaming", as: "gaming_vodafone"
      get 'outros', to: "pacotes_nos#outros", as: "outros_vodafone"
    end
  end
