...
meo_telemovel_list = [
  ...
  [ "M4 - MEO com tudo", "99,99", 
    ...
    "Cartões - 1 cartão | ilimitado", "VOZ - Chamadas ilimitadas Redes fixas nacionais 24h + 50 destinos internacionais (noite, 1.000 min)",
    Type.find_by(plano: "Telemóvel", company: Company.find_by("description like ?", "%meo%"))
  ],
...
meo_tv_net_voz_list = [
  [ "M3", "36,99", "TV - 150 Canais MEOBox | Pack Standard", "Internet - 500/100 Mbps Download/upload", 
  ...
  [ "M3", "30,99", "TV - 100 Canais | Pack Standard Sem MEOBox", 
